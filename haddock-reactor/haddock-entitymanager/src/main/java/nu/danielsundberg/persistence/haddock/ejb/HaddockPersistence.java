...
public class HaddockPersistence implements PersistenceProvider {
	...
	private Set<PersistenceUnitInfo> persistenceUnits = new HashSet<PersistenceUnitInfo>();
	
	@Override
	@SuppressWarnings({ "unchecked", "rawtypes" })
	public EntityManagerFactory createContainerEntityManagerFactory(PersistenceUnitInfo persistenceUnitInfo, Map arguments) {
		arguments.putAll(persistenceUnitInfo.getProperties());
		return new HaddockEntityManagerFactory(persistenceUnitInfo, arguments);
	}
